...
$581$--$887$\,ms in the reproducible snarkjs pipeline. The reference
implementation is available at \url{https://github.com/rafaelescrich/zk-otp}.
\end{abstract}
...
The reference Circom circuits, Solidity contracts, exported Groth16 verifiers,
test vectors, and reproducible evaluation artifacts are open source at
\url{https://github.com/rafaelescrich/zk-otp}.
